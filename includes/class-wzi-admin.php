        ...
        wp_localize_script(
            ...
            array(
                ...
                'strings' => array(
                    ...
                    'sync_error' => __('Error en la sincronización', 'woocommerce-zoho-integration'),
                    ...
                    'connection_success' => __('Conexión exitosa', 'woocommerce-zoho-integration'),
                    'connection_failed' => __('Conexión fallida', 'woocommerce-zoho-integration'),
                ),
            )
        );
